...
ServerEvents.recipes((event) => {
  ...
  // array of coral block to use for making sponges
  const CORAL_BLOCKS = [
  ...
  // use select coral block to make sponge
  CORAL_BLOCKS.forEach((id) =>
    event.recipes.botania.elven_trade(["minecraft:sponge"], id)
  );
